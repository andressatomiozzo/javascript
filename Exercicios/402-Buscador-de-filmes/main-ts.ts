...
const respostaTexto = document.querySelector<HTMLDivElement>("#resposta-texto");
const respostaPoster = document.querySelector<HTMLDivElement>("#resposta-poster");

if (!tituloInput || !anoInput || !pesqBtn || !resetBtn || !respostaPoster || !respostaTexto) throw new Error("Algum elemento não está ligado ao DOM");
...
const mostrarResultado = (dados: data) => {
  resetarResposta();
  criarElementos();
