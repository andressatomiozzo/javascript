...
if (!form || !alerta) throw new Error("Algum elemento não está ligado ao DOM");
...
form.addEventListener("submit", async (evento) => {
  ...
  const formData: FormData = new FormData(form);                                      // Cria um objeto com todos os dados do formulário (tipo especial: FormData)
