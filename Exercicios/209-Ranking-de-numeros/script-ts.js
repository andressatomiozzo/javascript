...
const arrayContainer = document.querySelector("#resposta-do-array");
const maiorBtn = document.querySelector("#maior-valor-btn");
const menorBtn = document.querySelector("#menor-valor-btn");
const maiorContainer = document.querySelector("#resposta-do-maior");
const menorContainer = document.querySelector("#resposta-do-menor");
